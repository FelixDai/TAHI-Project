...
syncevent REF3_ping_REF1 test_REF3, test_REF1;

syncevent REF1_ping_REF3 test_REF3, test_REF1;

syncevent finish_test setup_cleanup_REF1, setup_cleanup_REF2, setup_cleanup_REF3, setup_cleanup_TEST-TAR-SGW, cleanup_DUMPER, test_REF3, test_REF1;
...
command test_REF3 REF3 {
    ...
    print "BASENAME> as described in test scenario 5.2.8.";
    ...
    print "";
    print "BASENAME> REF-HOST2 transmits ICMPv6 Echo Request to REF-HOST1.";

    delay 2;
    REF3_CMD_CLEAR_NCE_IF1;
    REF3_CMD_PRINT_NCE_IF1;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX4_GA_2 -c 1 REF1_IF1_PREFIX1_GA_2 | tee /tmp/5.2.8.REF3.TEST-TAR-SGW.REF1.result";
    delay 3;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX4_GA_2 -c 1 REF1_IF1_PREFIX1_GA_2 | tee -a /tmp/5.2.8.REF3.TEST-TAR-SGW.REF1.result";
    delay 2;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX4_GA_2 -c 3 REF1_IF1_PREFIX1_GA_2 | tee -a /tmp/5.2.8.REF3.TEST-TAR-SGW.REF1.result";
    delay 1;
...
command test_REF1 REF1 {
    ...
    print "";
    print "BASENAME> REF-HOST1 transmits ICMPv6 Echo Request to REF-HOST2.";

    delay 2;
    REF1_CMD_CLEAR_NCE_IF1;
    REF1_CMD_PRINT_NCE_IF1;
    execute "/bin/sh -c REF1_CMD_PING6_FROM_SPEC_SRC_ADDR REF1_IF1_PREFIX1_GA_2 -c 1 REF3_IF1_PREFIX4_GA_2 | tee /tmp/5.2.8.REF1.TEST-TAR-SGW.REF3.result";
    delay 3;
    execute "/bin/sh -c REF1_CMD_PING6_FROM_SPEC_SRC_ADDR REF1_IF1_PREFIX1_GA_2 -c 1 REF3_IF1_PREFIX4_GA_2 | tee -a /tmp/5.2.8.REF1.TEST-TAR-SGW.REF3.result";
    delay 2;
    execute "/bin/sh -c REF1_CMD_PING6_FROM_SPEC_SRC_ADDR REF1_IF1_PREFIX1_GA_2 -c 3 REF3_IF1_PREFIX4_GA_2 | tee -a /tmp/5.2.8.REF1.TEST-TAR-SGW.REF3.result";
    delay 1;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/5.2.8.TEST-TAR-SGW_NAME.Link0.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF2 -c 10000 -s 0 -w /tmp/5.2.8.TEST-TAR-SGW_NAME.Link1.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF3 -c 10000 -s 0 -w /tmp/5.2.8.TEST-TAR-SGW_NAME.Link2.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF4 -c 10000 -s 0 -w /tmp/5.2.8.TEST-TAR-SGW_NAME.Link3.dump&";
    sync finish_start_tcpdump;
}
...
command setup_cleanup_REF2 REF2 {
    print "";
    print "5.2.8 (SGW vs SGW Tunnel Mode)";
    print "";
