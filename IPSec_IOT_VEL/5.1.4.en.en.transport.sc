...
command test_TEST-TAR-EN TEST-TAR-EN {
    ...
    print "BASENAME> as described in test scenario 5.1.4.";
    ...
    execute "/bin/sh -c TEST-TAR-EN_CMD_PING6_FROM_SPEC_SRC_ADDR TEST-TAR-EN_IF1_PREFIX2_GA_2 -c 1 LOGO_IF1_PREFIX1_GA_2 | tee /tmp/5.1.4.TEST-TAR-EN_NAME.LOGO_NAME.result";
    delay 3;
    execute "/bin/sh -c TEST-TAR-EN_CMD_PING6_FROM_SPEC_SRC_ADDR TEST-TAR-EN_IF1_PREFIX2_GA_2 -c 4 LOGO_IF1_PREFIX1_GA_2 | tee -a /tmp/5.1.4.TEST-TAR-EN_NAME.LOGO_NAME.result";
    delay 1;
    execute "/bin/sh -c TEST-TAR-EN_CMD_UNAME_A | tee -a /tmp/5.1.4.TEST-TAR-EN_NAME.LOGO_NAME.result";
    delay 1;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/5.1.4.TEST-TAR-EN_NAME.Link0.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF2 -c 10000 -s 0 -w /tmp/5.1.4.TEST-TAR-EN_NAME.Link1.dump&";
}
...
command setup_cleanup_REF2 REF2 {
    ...
    print "";
    print "5.1.4 (End-Node vs End-Node Transport Mode)";
    print "";
