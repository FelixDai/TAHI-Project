...
syncevent REF3_ping_TARGET test_REF3, test_TEST-TAR-EN;
   
syncevent TARGET_ping_REF3 test_REF3, test_TEST-TAR-EN;
...
command test_REF3 REF3 {
    ...
    print "BASENAME> as described in test scenario 5.3.8.";
    ...
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX3_GA_2 -c 1 TEST-TAR-EN_IF1_PREFIX1_GA_2 | tee /tmp/5.3.8.REF.TEST-TAR-EN_NAME.result";
    delay 3;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX3_GA_2 -c 1 TEST-TAR-EN_IF1_PREFIX1_GA_2 | tee -a /tmp/5.3.8.REF.TEST-TAR-EN_NAME.result";
    delay 2;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX3_GA_2 -c 3 TEST-TAR-EN_IF1_PREFIX1_GA_2 | tee -a /tmp/5.3.8.REF.TEST-TAR-EN_NAME.result";
    delay 1;
    
    sync TARGET_ping_REF3;
...
command test_TEST-TAR-EN TEST-TAR-EN  {
    ...
    sync TARGET_ping_REF3;
    print "";
    print "BASENAME> TGT-HOST1 transmits ICMPv6 Echo Request to REF-HOST.";

    delay 2;
    TEST-TAR-EN_CMD_CLEAR_NCE_IF1;
    TEST-TAR-EN_CMD_PRINT_NCE_IF1;
    execute "/bin/sh -c TEST-TAR-EN_CMD_PING6_FROM_SPEC_SRC_ADDR TEST-TAR-EN_IF1_PREFIX1_GA_2 -c 1 REF3_IF1_PREFIX3_GA_2 | tee /tmp/5.3.8.TEST-TAR-EN_NAME.REF.result";
    delay 3;
    execute "/bin/sh -c TEST-TAR-EN_CMD_PING6_FROM_SPEC_SRC_ADDR TEST-TAR-EN_IF1_PREFIX1_GA_2 -c 1 REF3_IF1_PREFIX3_GA_2 | tee -a /tmp/5.3.8.TEST-TAR-EN_NAME.REF.result";
    delay 2;
    execute "/bin/sh -c TEST-TAR-EN_CMD_PING6_FROM_SPEC_SRC_ADDR TEST-TAR-EN_IF1_PREFIX1_GA_2 -c 3 REF3_IF1_PREFIX3_GA_2 | tee -a /tmp/5.3.8.TEST-TAR-EN_NAME.REF.result";
    delay 1;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/5.3.8.TEST-TAR-EN_NAME.Link0.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF2 -c 10000 -s 0 -w /tmp/5.3.8.TEST-TAR-EN_NAME.Link1.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF3 -c 10000 -s 0 -w /tmp/5.3.8.TEST-TAR-EN_NAME.Link2.dump&";
    sync finish_start_tcpdump;
}
...
command setup_cleanup_REF2 REF2 {
    ...
    print "";
    print "5.3.8 (End-Node vs SGW Tunnel Mode)";
    print "";
