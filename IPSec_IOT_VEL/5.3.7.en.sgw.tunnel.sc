...
command test_REF3 REF3 {
    ...
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX3_GA_2 -c 1 LOGO_IF1_PREFIX1_GA_2 | tee /tmp/5.3.7.REF.LOGO_NAME.result";
    delay 3;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX3_GA_2 -c 1 LOGO_IF1_PREFIX1_GA_2 | tee -a /tmp/5.3.7.REF.LOGO_NAME.result";
    delay 2;
    execute "/bin/sh -c REF3_CMD_PING6_FROM_SPEC_SRC_ADDR REF3_IF1_PREFIX3_GA_2 -c 3 LOGO_IF1_PREFIX1_GA_2 | tee -a /tmp/5.3.7.REF.LOGO_NAME.result";
    delay 1;
...
command setup_DUMPER DUMPER {
    delay 5;
    sync start_setup;
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF1 -c 10000 -s 0 -w /tmp/5.3.7.TEST-TAR-SGW_NAME.Link0.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF2 -c 10000 -s 0 -w /tmp/5.3.7.TEST-TAR-SGW_NAME.Link1.dump&";
    execute "/bin/sh -c /usr/sbin/tcpdump -i DUMPER_IF3 -c 10000 -s 0 -w /tmp/5.3.7.TEST-TAR-SGW_NAME.Link2.dump&";
}
