...
my %nut = (
	typ => "ha", adr => "3ffe:501:ffff:100:2e0:29ff:fe10:da52",
	rng => "::/0" , mnp => "",
);
...
my $cmn_rng = "::/0";
my @tns = (
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:11",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:111::/64",
	  sa1 => { id => "111" }, sa2 => { id => "112" }, sa3 => { id => "113" }, sa4 => { id => "114" },
	  sa5 => { id => "115" }, sa6 => { id => "116" }, sa7 => { id => "117" }, sa8 => { id => "118" },
	  sa9 => { id => "119" }, saa => { id => "11A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:12",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:112::/64",
	  sa1 => { id => "121" }, sa2 => { id => "122" }, sa3 => { id => "123" }, sa4 => { id => "124" },
	  sa5 => { id => "125" }, sa6 => { id => "126" }, sa7 => { id => "127" }, sa8 => { id => "128" },
	  sa9 => { id => "129" }, saa => { id => "12A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:12",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:113::/64",
	  sa1 => { id => ""    }, sa2 => { id => ""    }, sa3 => { id => ""    }, sa4 => { id => ""    },
	  sa5 => { id => ""    }, sa6 => { id => ""    }, sa7 => { id => ""    }, sa8 => { id => ""    },
	  sa9 => { id => "139" }, saa => { id => "13A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:14",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:114::/64",
	  sa1 => { id => "141" }, sa2 => { id => "142" }, sa3 => { id => "143" }, sa4 => { id => "144" },
	  sa5 => { id => "145" }, sa6 => { id => "146" }, sa7 => { id => "147" }, sa8 => { id => "148" },
	  sa9 => { id => "149" }, saa => { id => "14A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:21",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:121::/64",
	  sa1 => { id => "211" }, sa2 => { id => "212" }, sa3 => { id => "213" }, sa4 => { id => "214" },
	  sa5 => { id => "215" }, sa6 => { id => "216" }, sa7 => { id => "217" }, sa8 => { id => "218" },
	  sa9 => { id => "219" }, saa => { id => "21A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:22",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:122::/64",
	  sa1 => { id => "221" }, sa2 => { id => "222" }, sa3 => { id => "223" }, sa4 => { id => "224" },
	  sa5 => { id => "225" }, sa6 => { id => "226" }, sa7 => { id => "227" }, sa8 => { id => "228" },
	  sa9 => { id => "229" }, saa => { id => "22A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:22",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:123::/64",
	  sa1 => { id => ""    }, sa2 => { id => ""    }, sa3 => { id => ""    }, sa4 => { id => ""    },
	  sa5 => { id => ""    }, sa6 => { id => ""    }, sa7 => { id => ""    }, sa8 => { id => ""    },
	  sa9 => { id => "239" }, saa => { id => "23A" }, },
	{ flg => 1, typ => $cmn_tntyp, adr => "3ffe:501:ffff:100:200:ff:fe00:24",
	  rng => $cmn_rng, mnp => "3ffe:501:ffff:124::/64",
	  sa1 => { id => "241" }, sa2 => { id => "242" }, sa3 => { id => "243" }, sa4 => { id => "244" },
	  sa5 => { id => "245" }, sa6 => { id => "246" }, sa7 => { id => "247" }, sa8 => { id => "248" },
	  sa9 => { id => "249" }, saa => { id => "24A" }, },
);
